    ...
    return (
        <div>
            <section className="offer-area secondary-bg pt-120 pb-200">
                ...
                >
                    <img
                        src="frontend/assets/images/shape/offer-shadow-shape.png"
                        alt="shadow"
                    />
                </div>
                <div className="offer__shape-left">
                    <img
                        ...
                        data-wow-duration="1500ms"
                        src="frontend/assets/images/shape/offer-bg-shape-left.png"
                        alt="shape"
                    />
                </div>
                <div className="offer__shape-right">
                    <img
                        ...
                        data-wow-delay="400ms"
                        data-wow-duration="1500ms"
                        src="frontend/assets/images/shape/offer-bg-shape-right.png"
                        alt="shape"
                    />
                </div>
                    ...
                    <div className="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-95">
                        <div className="section-header">
                            ...
                            <h2
                                ...
                                data-wow-duration="1500ms"
                            >
                                Enhance and Pioneer Using <br /> Technology
                                Trends
                            </h2>
                        </div>
                        <a
                        ...
                        >
                            <div className="offer__item">
                                <div className="shape-top">
                                    <img
                                        src="frontend/assets/images/shape/offter-item-shape-top.png"
                                        alt="shape"
                                    />
                                </div>
                                <div className="shape-bottom">
                                    <img
                                        src="frontend/assets/images/shape/offter-item-shape-bottom.png"
                                        alt="shape"
                                    />
                                </div>
