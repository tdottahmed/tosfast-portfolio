...
var chartColumnColors = getChartColorsArray("column_chart"),
                ...
                series: [
                    {
                        name: "Inflation",
                        data: [
                            2.5, 3.2, 5, 10.1, 4.2, 3.8, 3, 2.4, 4, 1.2, 3.5,
                            0.8,
                        ],
                    },
                ],
    ...
    dumbbellChartColors =
        (groupedStackedColors &&
            ((options = {
                ...
                chart: { type: "bar", height: 350, stacked: !0 },
                stroke: { width: 1, colors: ["#fff"] },
                dataLabels: { formatter: (e) => e / 1e3 + "K" },
                ...
                yaxis: { labels: { formatter: (e) => e / 1e3 + "K" } },
                legend: { position: "top", horizontalAlign: "left" },
            }),
            (chart = new ApexCharts(
                document.querySelector("#grouped_stacked_columns"),
                options
            )).render()),
    ...
    chartColumnMarkersColors =
        (dumbbellChartColors &&
            ...
            (chart = new ApexCharts(
                document.querySelector("#dumbbell_chart"),
                options
            )).render()),
        ...
        (chartColumnMarkersColors &&
            ((options = {
                ...
                legend: {
                    ...
                    markers: { fillColors: chartColumnMarkersColors },
                },
            }),
            (chart = new ApexCharts(
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            13.57, 15.75, 17.1, 19.8, -27.03, -54.4, -47.2,
                            -43.3, -18.6, -48.6, -41.1, -39.6, -37.6, -29.4,
                            -21.4, -2.4,
                        ],
                    },
                ],
...
function makeData() {
    ...
    return [
        { x: "2011", y: e[0].y, color: colors[0], quarters: e[0].quarters },
        { x: "2012", y: e[1].y, color: colors[1], quarters: e[1].quarters },
        { x: "2013", y: e[2].y, color: colors[2], quarters: e[2].quarters },
        { x: "2014", y: e[3].y, color: colors[3], quarters: e[3].quarters },
        { x: "2015", y: e[4].y, color: colors[4], quarters: e[4].quarters },
        { x: "2016", y: e[5].y, color: colors[5], quarters: e[5].quarters },
    ];
}
function updateQuarterChart(e, t) {
    ...
    if (e.w.globals.selectedDataPoints[0]) {
        for (
            var r = e.w.globals.selectedDataPoints, s = 0;
            s < r[0].length;
            s++
        ) {
            var l = r[0][s],
                n = e.w.config.series[0];
            o.push({ name: n.data[l].x, data: n.data[l].quarters }),
...
var chart,
    ...
    chartColumnDistributedColors =
        (chartQuarter.render(),
        chart.addEventListener("dataPointSelection", function (e, t, o) {
            var a = document.querySelector("#chart-quarter"),
                r = document.querySelector("#chart-year");
            1 !== o.selectedDataPoints[0].length ||
                a.classList.contains("active") ||
    ...
    (optionsGroup = {
        ...
        tooltip: {
            x: {
                formatter: function (e) {
                    return (
                        "Q" + dayjs(e).quarter() + " " + dayjs(e).format("YYYY")
                    );
                },
            },
        },
