    ...
    if (null !== document.getElementById(a)) {
        var e =
                ...
                ("-" + document.documentElement.getAttribute("data-theme") ??
                    ""),
            e =
                document.getElementById(a).getAttribute(e) ??
                document.getElementById(a).getAttribute("data-colors");
        if (e)
            return (e = JSON.parse(e)).map(function (a) {
                var e = a.replace(" ", "");
                return -1 === e.indexOf(",")
                    ? getComputedStyle(
        ...
        console.warn("data-colors attributes not found on", a);
    }
}
            ...
            ((options = {
                ...
                legend: {
                    ...
                    formatter: function (a, e) {
                        return a + ":  " + e.w.globals.series[e.seriesIndex];
                    },
...
(chartStorkeRadialbarColors = getChartColorsArray("stroked_radialbar")) &&
    ((options = {
        ...
        plotOptions: {
            radialBar: {
                hollow: {
                    margin: 15,
                    size: "65%",
                    image: "./assets/admin/images/comingsoon.png",
                    imageWidth: 56,
                    imageHeight: 56,
                    imageClipped: !1,
                },
        ...
        fill: {
            type: "image",
            image: { src: ["./assets/admin/images/small/img-4.jpg"] },
        },
        stroke: { lineCap: "round" },
        labels: ["Volatility"],
    }),
