...
var options,
    ...
    chartScatterImagesColors =
        (chartScatterDateTimeColors &&
            ((options = {
                series: [
                    {
                        name: "TEAM 1",
        ...
        getChartColorsArray("images_scatter"));
chartScatterImagesColors &&
    ((options = {
        series: [
            {
        ...
        fill: {
            ...
            image: {
                src: [
                    "./assets/admin/images/users/avatar-1.jpg",
                    "./assets/admin/images/users/avatar-2.jpg",
                ],
                width: 40,
                height: 40,
            },
